...
sonatypeProfileName := "ai.tripl.arc-deltaperiod-config-plugin"
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/tripl-ai/arc-deltaperiod-config-plugin"),
    "scm:git@github.com:tripl-ai/arc-deltaperiod-config-plugin.git"
  )
)
developers := List(
